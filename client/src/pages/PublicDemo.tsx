...
const products = [
  { name: "فلتر 7 مراحل", description: "حل متكامل للاستخدام المنزلي مع متابعة التركيب والصيانة.", image: heroImage, tone: "bg-teal-50" },
  { name: "شمعات وممبرين", description: "قطع غيار وخدمة تغيير مناسبة لمراحل الفلتر المختلفة.", image: cartridgesImage, tone: "bg-cyan-50" },
  { name: "صيانة ومبردات", description: "فحص الوصلات والتسريب والمبرد والخزان داخل المنزل.", image: maintenanceImage, tone: "bg-amber-50" },
];

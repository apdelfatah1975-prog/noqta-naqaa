...
const products = [
  { name: "فلتر 7 مراحل", description: "حل متكامل للاستخدام المنزلي مع متابعة التركيب والصيانة.", image: premiumFilterImage, tone: "bg-teal-50" },
  { name: "شمعات وممبرين", description: "قطع غيار وخدمة تغيير مناسبة لمراحل الفلتر المختلفة.", image: premiumCartridgesImage, tone: "bg-cyan-50" },
  { name: "صيانة منزلية", description: "فحص الوصلات والتسريب والخزان مع فني يصل إلى بابك.", image: premiumServiceImage, tone: "bg-amber-50" },
  { name: "مبردات مياه", description: "اختيارات عملية للمطبخ والمكتب مع توضيح المواصفات قبل الطلب.", image: coolerImage, tone: "bg-sky-50" },
];
...
export default function PublicDemo() {
  ...
  return (
    <div dir="rtl" className="min-h-screen overflow-x-hidden bg-[#f5fbfa] text-slate-900">
      <header className="sticky top-0 z-20 border-b border-teal-950/10 bg-white/90 backdrop-blur-lg"><div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6"><a href="#top" className="flex items-center gap-3"><span className="grid h-11 w-11 place-items-center rounded-2xl bg-teal-700 text-white shadow-lg shadow-teal-700/20"><Droplets className="h-6 w-6" /></span><span><strong className="block text-base font-black text-teal-950">نقطة نقاء</strong><small className="text-xs font-bold text-teal-700">فلاتر مياه في الرياض</small></span></a><a href="tel:+201008797774" className="hidden items-center gap-2 rounded-xl bg-teal-50 px-4 py-2.5 text-sm font-black text-teal-800 sm:flex"><Phone className="h-4 w-4" /> اتصل الآن</a></div></header>
      ...
      <main id="top">
        ...
        <section className="bg-white px-4 py-14 sm:px-6"><div className="mx-auto max-w-6xl"><div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between"><div><p className="font-black text-teal-700">من قلب الخدمة</p><h2 className="mt-2 text-3xl font-black text-teal-950">صور توضح جودة اهتمامنا</h2></div><p className="max-w-md text-sm leading-7 text-slate-600">من المنتج إلى التركيب، نرتب لك التجربة بصورة واضحة قبل الحجز.</p></div><div className="mt-7 grid gap-4 sm:grid-cols-2 lg:grid-cols-4"><figure className="group overflow-hidden rounded-3xl"><img src={premiumFilterImage} alt="فلتر مياه منزلي" className="h-64 w-full object-cover transition duration-500 group-hover:scale-105" /><figcaption className="bg-teal-950 p-4 text-sm font-black text-white">حلول فلترة منزلية</figcaption></figure><figure className="group overflow-hidden rounded-3xl"><img src={premiumCartridgesImage} alt="شمعات فلاتر مياه" className="h-64 w-full object-cover transition duration-500 group-hover:scale-105" /><figcaption className="bg-cyan-950 p-4 text-sm font-black text-white">شمعات وقطع غيار</figcaption></figure><figure className="group overflow-hidden rounded-3xl"><img src={premiumServiceImage} alt="فني يقدم خدمة منزلية" className="h-64 w-full object-cover transition duration-500 group-hover:scale-105" /><figcaption className="bg-teal-800 p-4 text-sm font-black text-white">خدمة منزلية منظمة</figcaption></figure><figure className="group overflow-hidden rounded-3xl"><img src={coolerImage} alt="مبرد مياه منزلي" className="h-64 w-full object-cover transition duration-500 group-hover:scale-105" /><figcaption className="bg-amber-500 p-4 text-sm font-black text-amber-950">مبردات للاستخدام اليومي</figcaption></figure></div></div></section>

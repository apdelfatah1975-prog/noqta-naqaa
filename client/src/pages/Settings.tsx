...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("purepoint-settings-changed", onChange);
  }, []);

  ...
  return (
    <main dir="rtl" className="mx-auto w-full max-w-5xl px-4 py-6 sm:px-6">
      ...
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-teal-100 bg-white p-4 shadow-sm">
        ...
        <div className="flex gap-2"><Button onClick={retry} className="gap-2 bg-teal-700 hover:bg-teal-800"><RefreshCw className="h-4 w-4" />إعادة المحاولة</Button><Link href="/"><Button variant="outline">العودة للرئيسية</Button></Link></div>
      </div>

...
export default function Reports() {
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet([
      ...
      { البيان: "إجمالي مستحقات الفنيين", "الإجمالي بالريال": financial.technicianRequired / 100 },
      { البيان: "إجمالي المدفوع للفنيين", "الإجمالي بالريال": financial.technicianPayments / 100 },
      { البيان: "إجمالي المتبقي للفنيين", "الإجمالي بالريال": financial.technicianRemaining / 100 },

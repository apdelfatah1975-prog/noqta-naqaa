...
export default function Reports() {
  ...
  const cards = useMemo(() => data ? [
    ...
    { label: "صافي الحركة", description: "الإيرادات ناقص المصروفات", value: money(data.summary.balance), unit: "ريال", tone: "bg-slate-950 text-white", icon: FileBarChart },

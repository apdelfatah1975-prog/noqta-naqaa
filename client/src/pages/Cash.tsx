...
export default function Cash() {
  ...
  const cashQueryInput = useMemo(() => ({ incomeFilter, month: dateFilterMode === "month" ? selectedMonth || undefined : undefined, startDate: dateFilterMode === "range" ? startDate || undefined : undefined, endDate: dateFilterMode === "range" ? endDate || undefined : undefined, search: search.trim() || undefined }), [incomeFilter, dateFilterMode, selectedMonth, startDate, endDate, search]);

...
type CashTransaction = { id: number; transactionType: "income" | "expense"; currency?: Currency | null; amount: number; category: string; transactionDate: Date; recipientName: string | null; paymentMethod?: string | null; notes: string | null };

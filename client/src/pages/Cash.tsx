...
export default function Cash() {
  ...
  return <div className="mx-auto max-w-7xl space-y-6">
    ...
    <details className="soft-card group">
      <summary className="flex cursor-pointer list-none items-center justify-between p-5 font-extrabold text-teal-950"><span>تفاصيل إضافية للخزينة</span><span className="text-sm font-bold text-muted-foreground group-open:hidden">عرض التجميع ورواتب الفنيين</span><span className="hidden text-sm font-bold text-muted-foreground group-open:inline">إخفاء التفاصيل</span></summary>

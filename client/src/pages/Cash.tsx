...
export default function Cash() {
  ...
  return <div className="mx-auto max-w-7xl space-y-6">
    ...
    <p className="rounded-2xl border border-teal-100 bg-teal-50/60 px-4 py-3 text-sm font-bold leading-6 text-teal-900">للوصول السريع، استخدم فلاتر سجل العمليات لمعرفة إيرادات التركيبات والصيانة أو راتب كل فني وما تم دفعه له فعليًا.</p>

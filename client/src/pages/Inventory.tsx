...
export default function Inventory() {
  ...
  const inventoryStats = useMemo(() => {
    ...
    return {
      ...
      lowStock: data.items.filter(item => item.currentBalance <= 2).length,
...
function formatMoney(minorAmount: number) { return `${(minorAmount / 100).toLocaleString("ar-SA", { maximumFractionDigits: 2 })} ر.س`; }

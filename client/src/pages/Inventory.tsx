...
export default function Inventory() {
  ...
  const detailItem = detailItemId ? (data.items as any[]).find(item => item.id === detailItemId) : null;
  const detailMovements = detailItemId ? (data.movements as any[]).filter(movement => movement.inventoryItemId === detailItemId) : [];

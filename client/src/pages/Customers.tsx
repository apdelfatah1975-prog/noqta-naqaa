...
export default function Customers() {
  ...
  function submit(event: FormEvent) {
    ...
    if (form.id) {
      ...
      updateCustomer.mutate({ id: form.id, manualCode: form.manualCode.trim() || null, name: form.name, phone: form.phone, address: form.address || null, latitude: form.latitude || null, longitude: form.longitude || null, notes: form.notes || null, serviceDate: new Date(form.firstVisitDate) });
      return;
    }
    if (isOffline) {

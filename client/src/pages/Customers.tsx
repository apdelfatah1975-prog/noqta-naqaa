...
export default function Customers() {
  ...
  return (
    <div className="-mx-4 -mt-4 w-[calc(100%+2rem)] max-w-none space-y-4 sm:-mx-6 sm:-mt-6 sm:w-[calc(100%+3rem)] lg:-mx-8 lg:w-[calc(100%+4rem)]">

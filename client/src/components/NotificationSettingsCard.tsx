...
export function NotificationSettingsCard() {
  ...
  function payload() {
    ...
    return { leadDays: 1, alertHour: Number.isFinite(hour) ? hour : 9, alertMinute: Number.isFinite(minute) ? minute : 0, timezoneOffsetMinutes: -new Date().getTimezoneOffset(), companyWhatsAppPhone: companyWhatsAppPhone.trim() || null };
  }
